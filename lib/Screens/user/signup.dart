  ...
  void _signUp() {
    ...
    setState(() {
      ...
      _validZip = UtilValidator.validate(
          data: _textZipController.text, type: ValidateType.pincode);

      _validEmail = UtilValidator.validate(
          data: _textEmailController.text, type: ValidateType.email);
                  ...
                  children: [
                        ...
                        children: <Widget>[
                          Stack(
                            ...
                            children: <Widget>[
                              _buildAvatar(),
                              IconButton(
                                icon: Image.asset(Images.camera,
                    ...
                    Container(
                        ...
                        child: AppTextInput(
                          ...
                          errorText:
                              Translate.of(context).translate(_validFirstName),
                    ...
                    Container(
                        ...
                        child: AppTextInput(
                          ...
                          errorText:
                              Translate.of(context).translate(_validLastName),
                          icon: Icon(Icons.clear),
                    ...
                    Container(
                        ...
                        child: AppTextInput(
                          ...
                          errorText:
                              Translate.of(context).translate(_validMobile),
                          icon: Icon(Icons.clear),
